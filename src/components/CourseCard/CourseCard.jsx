  ...
  return (
    <div id={id} className="course-card-wrapper">
      <div className="course-info">
        ...
        <div data-testid="desc" className="course-about">
          {description}
        </div>
      </div>
